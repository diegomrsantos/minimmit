...
4. Can invalid states be made unrepresentable with the local type shape?
5. If invalid input is possible, is it rejected at the boundary with a precise
   error?
6. Do tests cover attempts to violate the invariant?
