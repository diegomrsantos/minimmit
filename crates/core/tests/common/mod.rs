...
pub(crate) const ONE_FAULT: usize = 1;
pub(crate) const MIN_VALIDATORS_WITH_ONE_FAULT: u64 = 6;
pub(crate) const BELOW_MIN_VALIDATORS_WITH_ONE_FAULT: u64 = 5;
...
pub(crate) fn transaction(id: u64) -> TransactionId {
...
pub(crate) fn validators(count: u64) -> Vec<ValidatorId> {
...
pub(crate) fn vote(signer: u64, block_id: u64, view_number: u64) -> Vote {
    Vote::new(validator(signer), block(block_id), view(view_number))
}

pub(crate) fn nullify(signer: u64, view_number: u64) -> Nullify {
